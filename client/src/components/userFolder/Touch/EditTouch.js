...
import { geteditTouch, editTouch, deleteTouch } from "../../../api/touch";
...
const EditTouch = () => {
  ...
  const handleSubmit = async (evt) => {
    ...
    history.push("/user/dashboard/touch");
  };
  ...
  const deleteTouchData = async (id) => {
