...
import { geteditTouch, editTouch, deleteSim } from "../../../api/simTry";
...
const EditTouch = () => {
  ...
  const handleSubmit = async (evt) => {
    ...
    history.push("/user/dashboard/sim-try");
  };
        ...
        <div className="card card_create ">
          <div className="card-body">
            <div className="card-title ">
              <h2 align="center">Edit SimTry </h2>
