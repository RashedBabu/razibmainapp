...
import { geteditLcd, editLcd, deleteLcd } from "../../../api/lcd";
...
const EditLcd = () => {
  ...
  const handleSubmit = async (evt) => {
    ...
    history.push("/user/dashboard/lcd");
  };
  const deleteLcdData = async (id) => {
    await deleteLcd(id);
