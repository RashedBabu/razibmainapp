...
import { getBattery, deleteBattery } from "../../../api/battery";
...
const AllBattery = () => {
  ...
  const deleteBatteryData = async (id) => {
                  ...
                  {betterys
                    ...
                    .map((display, key) => (
                      <tr key={key}>
                        ...
                        <td className="td_color">{display.l_sell} </td>
                        <td className="th_date">{display.date} </td>
                        <td className="td_action">
                          <Link
                            className="btn btn-outline-primary mr-2"
                            to={`/user/dashboard/battery/edit/${display._id}`}
                          >
                          ...
                          {/* <Link className="btn btn-outline-danger">
                            <i
                              ...
                              onClick={() => deleteBatteryData(display._id)}
                            ></i>
                          </Link> */}
                        </td>
                      </tr>
