...
const EditBattery = () => {
  ...
  const loadUserData = async () => {
    const response = await geteditBattery(id);
  ...
  const handleSubmit = async (evt) => {
    ...
    history.push("/user/dashboard/speaker-dum");
  };
  const deleteSpeakerData = async (id) => {
        ...
        <div className="card card_create ">
          <div className="card-body">
            <div className="card-title ">
              <h2 align="center">Edit Speaker </h2>
