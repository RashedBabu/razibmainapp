...
import { getDisplay, deleteDisplay } from "../../../api/display";
        ...
        <div className="card-body">
          <div className="card-title">
            <div className="table">
              ...
              <table className="table table-hover table-fixed-dis">
                <thead align="center">
                  ...
                  {users
                    ...
                    .map((display, key) => (
                      <tr key={key}>
                        ...
                        <td className="td_color price_1 ">{display.price}</td>
                        <td className="th_color price_1">{display.price2} </td>
