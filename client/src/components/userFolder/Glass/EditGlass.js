...
import { geteditTouch, editTouch, deleteGalss } from "../../../api/glass";
...
const EditTouch = () => {
  ...
  const loadUserData = async () => {
    const response = await geteditTouch(id);
  ...
  const handleSubmit = async (evt) => {
    ...
    history.push("/user/dashboard/glass");
  };
  ...
  const deleteGlassData = async (id) => {
    await deleteGalss(id);
